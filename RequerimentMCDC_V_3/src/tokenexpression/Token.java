...
//        String exp = pp.removeComment(str);
        ...
        strAr[0] = "(tr.isTriangle(a, b, c))";
        strAr[1] = "(tr.isEquilateral(a, b, c))";
        strAr[2] = "(tr.isIsosceles(a, b, c))";
        strAr[3] = "(tr.isScalene(a, b, c))";
        strAr[4] = "((a == b) && (a == c) && (b == c))";
        strAr[5] = "(((a == b) && (a != c)) || ((a == c) && (a != b)) || ((b == c) && (a != b)))";
        strAr[6] = "((a != b) && (a != c) && (b != c))";
        strAr[7] = "(a + b > c)";
        strAr[8] = "(a + c > b)";
        strAr[9] = "(b + c > a)";
        ...
        for (int i = 0; i < strAr.length; i++) {
            ...
            String exp = pp.removeComment(strAr1);
            tokenizem(exp);
            
        }      
         
//        String exp = pp.removeComment(strAr[4]);
