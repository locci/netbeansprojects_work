    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ret != JFileChooser.CANCEL_OPTION){       
            ...
            /* TODO output your page here. You may use following sample code. */
                ...
                out.println("<th>");
                out.println("<font size=\"15\" color=\"white\" face = \"verdana\">Requeriment Tool - Black Box</font>");                
                out.println("</th>");
                out.println("</th>");
                out.println("</thead>");
                out.println("<tbody>");
                ...
                out.println("<font size=\"4\" color=\"white\" face = \"verdana\">XML Files Diretory : </font>" 
                        + System.getProperty("user.home") + "/.blackBox");
                out.println("</td>");
                out.println("</tr>");
                out.println("</tbody>");
                out.println("</table>");
        ...
        RequirementBlackBox.generateRequirementBlackBox(str);          
