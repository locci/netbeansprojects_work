 ...
 * @author alexandre
 */
public class LoadFileCondition extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ret != JFileChooser.CANCEL_OPTION){            
            ...
            /* TODO output your page here. You may use following sample code. */
                ...
                out.println("<th>");
                out.println("<font size=\"15\" color=\"white\" face = \"verdana\">Requeriment Tool - Condition Coverage</font>");                
                out.println("</th>");
                out.println("</th>");
                out.println("</thead>");
                out.println("<tbody>");
                ...
                for (int i = 0; i < List.listFile.size(); i++) {
                    ...
                    RequirementCoverageCondition.generateRequirementCoverageCondition(List.listFile.get(i));
                    out.println("<br>"); 
                ...
                out.println("<font size=\"4\" color=\"white\" face = \"verdana\">XML Files Diretory : </font>" 
                        + System.getProperty("user.home") + "/.condition");
                out.println("</td>");
                out.println("</tr>");
                out.println("</tbody>");
                out.println("</table>");                
        ...
        for (int j = 0; j < List.listFile.size(); j++) {
                    
            RequirementCoverageCondition.generateRequirementCoverageCondition(List.listFile.get(j));
